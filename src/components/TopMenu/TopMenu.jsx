...
const MENU_ITEMS = [
    {
        ...
        hasDropdown: true,
        items: [
            {text: "Tạo danh mục mới", icon: <FaPlusCircle />}
        ]
    },
    {
        title: "VN30",
        ...
        <div className="top-menu-container">
            <div className="top-menu-left">
                <div className="search-box">
                    ...
                    <MdAddBox className="search-icon" style={{position: 'absolute', right: '0px', top: '50%', transform: 'translateY(-50%)', color: '#007bff', width: '40px', height: '40px'}} />
                </div>
                            ...
                            {menu.hasDropdown && (
                                <div className="dropdown-menu">
                                    {menu.items.map((item, itemIndex) => (
                                        <div key={itemIndex} className={`dropdown-item ${item.active ? 'active' : ''}`}>
